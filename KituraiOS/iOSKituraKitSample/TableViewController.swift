...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let aStudent = studentsLoaded[indexPath.row]
        cell.textLabel?.text = studentsLoaded[indexPath.row].firstName + " " + studentsLoaded[indexPath.row].lastName
        cell.detailTextLabel?.text = studentsLoaded[indexPath.row].cohort + ", " + studentsLoaded[indexPath.row].profile
